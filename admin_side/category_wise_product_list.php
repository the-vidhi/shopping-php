...
<head>
<title>Rattle n Roll  | Category-Product-List</title>
<meta charset="utf-8">
...
<h4 class="font-weight-bold py-3 mb-0">Category Product List</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item active"><a href="category_wise_product_list.php">Category Product List</a></li>
</ol>
</div>
<div class="row">
...
<?php
$cid=$_GET['cid'];
$qry = $link->rawQuery("select * from producttb p , product_categorytb c where p.category_id=c.category_id and c.category_id=?",array($cid));
if($link->count > 0)
{
	foreach($qry as $q)
	{
...
<tr>
<td><h4 class="font-weight-bold mb-0"><?php echo $cat; ?></h4></td>
</tr>
...
$cid=$_GET['cid'];
$qry = $link->rawQuery("select * from producttb p , product_categorytb c , vendor_reg v,agetb a where a.age_id=p.age_id and p.category_id=c.category_id and p.vendor_id=v.vendor_id and c.category_id=?",array($cid));
if($link->count > 0)
{
	foreach($qry as $q1)
	{ ?>
